...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'category_category', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['category.Category'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('qt', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.create_table(u'category_oldcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'category', ['OldCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'category_oldcategory')
    ...
    models = {
        u'category.category': {
            ...
            'qt': ('django.db.models.fields.IntegerField', [], {}),
